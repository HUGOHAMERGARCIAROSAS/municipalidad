...
<section class="content">
	<div class="container-fluid">
		<div class="card card-gray"  style = "overflow-y : auto; height:45vh">
			<!-- Desplegar y contraer contenido -->
			<div class="card-header">
                                ...
                                if(element.Asientos==1){
                                    ...
                                    if(lenAsientos==null){
                                        ...
                                        if(element.listarAsientosResponse.asientos.listAsientos.numPag>1){
                                            ...
                                            htmlAsientos+='<td>';
                                            htmlAsientos+='<div class="dropdown"><button class="btn btn-success  dropdown-toggle" data-toggle="dropdown" type="button">Lista Pag.<span class="caret"></span></button>' +
                                            ...
                                            for(var j=0;j<lenpaginasAsientos;j++){
                                                ...
                                                htmlAsientos+='<li class=" tam-cuerpo"><a target="_blank" id="link" href="'+url+'">' +
													'<button class="btn btn-success" type="submit"><i aria-hidden="true" class="fa fa-eye"></i></button></a>nroPagRef: '+nroPagRef+', Pagina: '+pagina+'</li>';
