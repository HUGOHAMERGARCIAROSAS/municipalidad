	...
	<script type="text/javascript">
        ...
        function obtenerDatos()
        {
            ...
            function construirTablaSingular(index, element){
                ...
                html+='<td style="vertical-align:middle;"><button type="button" class="btn btn-warning btn-sm"  data-toggle="modal" data-numero_partida="'+numero_partida+'" data-registro="'+registro+'" data-oficina="'+oficina+'" data-target="#AbrirBuscarAsiento"> <i class="far fa-eye"></i> Ver Asientos </button></td>';
