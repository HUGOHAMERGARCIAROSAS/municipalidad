        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('reniec/dni/consultar')}}" onclick="event.preventDefault(); 
                document.getElementById('reniec/dni/consultar-form').submit();"  class="nav-link">
                  <i class="fas fa-list-ul nav-icon"></i>
                  <p>Consultar</p>
                </a>
                <form id="reniec/dni/consultar-form" action="{{url('reniec/dni/consultar')}}" method="GET" style="display: none;">
                {{csrf_field()}} 
                </form>
              </li>
            </ul>
