                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="container-fluid card" style="padding: 1%">
                                    {!! Form::open(['url'=>'/administracion/tareas/registrar','method'=>'post']) !!}
                                    {!! Form::token() !!}
                                    <div class="row">
                                        <div class="form-group-lg col-lg-12 col-md-12 col-sm-12">
                                            <label>Seleccionar Modulo</label>
                                            <select class="form-control  select2-blue" name="modulo" id="modulo">
                                    ...
                                    <div class="row">
                                        <div class="form-group-lg col-lg- col-md-12 col-sm-12">
                                            <label>Seleccionar Grupo</label>
                                            <select class="form-control  select2-blue" name="grupo" id="grupo">
