<div class="modal fade show" id="{{"modal-derivar-".$e->coddocumento}}" style="display: none; padding-right: 17px;" aria-modal="true">
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            {!! Form::open(['url'=>'tramitedocumentario/expediente/derivar','method'=>'POST']) !!}
            {!! Form::token() !!}
            <div class="modal-header">
                <h4 class="modal-title text-center">DERIVAR EL EXPEDIENTE {{$e->numero}}</h4>
            ...
            <div class="modal-body text-left">
                ...
                <input type="hidden" name="area" value="{{$areas[0]->valor}}">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <label>Área a derivar:</label>
                        <select class="form-control  select2-blue" name="area1" id="areaT">
                ...
                <div class="row">
                    <div class="form-group-lg col-lg-12 col-md-12 col-sm-12">
                        ...
                        <select class="form-control select2bs4 select2-blue" name="trab" id="personaT" style="width: 100%">
                        </select>
                    </div>
                </div>
                <div class="row">
