                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="container-fluid card" style="padding: 1%">
                            {!! Form::open(['url'=>'tramitedocumentario/areaderivados','method'=>'post']) !!}
                            {!! Form::token() !!}
                            <div class="card card-gray">
                                <div class="card-body">
                                    <div class="row" style="padding-bottom: 0.5%;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <label>Área Derivada:</label>
                                            <select class="form-control form-control-sm select2-blue" name="aread" id="aread">
                                                <option value="" selected>Seleccionar Área</option>
                                                @foreach($areasd as $ad)
                                                    <option value="{{$ad->valor}}">{{$ad->texto}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
