                                                ...
                                                <table class="table table-hover text-center table-sm">
                                                    ...
                                                    @foreach($informes as $i)
                                                        <tr style="font-size: 12px; padding-top: 3px; padding-bottom: 3px; height: 10px;">
                                                            ...
                                                            <td style=" padding-top: 3px; padding-bottom: 3px; height: 10px;">{{$i->expediente}}</td>
                                                            ...
                                                            <td style=" padding-top: 3px; padding-bottom: 3px; height: 10px;">
                                                                {!! Form::open(['url'=>'tramitedocumentario/informe/anexo','method'=>'post','style'=>'display: inline;']) !!}
                                                                {!! Form::token() !!}
                                                                ...
                                                                {!! Form::close() !!}
                                                                @if($i->estado!='P')
                                                                    {!! Form::open(['url'=>'tramitedocumentario/informe/anular','method'=>'post','id'=>"Aexped-".$i->idinforme,'style'=>'display: inline;']) !!}
                                                                    {!! Form::token() !!}
                                                                    <input type="hidden" name="id"
                                                                           value="{{$i->idinforme}}">
                                                                    <button type="submit"
