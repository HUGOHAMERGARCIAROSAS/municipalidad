                                                    ...
                                                    <table class="table table-hover text-center table-sm">
                                                        ...
                                                        @foreach($informes as $i)
                                                            <tr style="font-size: 12px; padding-top: 3px; padding-bottom: 3px; height: 10px;">
                                                                ...
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 10px;">@if($i->estado=='P') <span style="color:#F00">Pendiente</span>  @elseif($i->estado=='T') <span style="color:#3CF">Tramite</span> @elseif($i->estado=='A') <span style="color:#3C9">Archivado</span> @elseif($i->estado=='D') <span style="color:#339">Devuelto</span> @endif</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 10px;">{{$i->nota}}</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 10px;"><button type="button" class="btn btn-default" title="Descargar"><span class="fa fa-download"></span></button></td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 10px;">
                                                                    @if($i->estado!='P')
                                                                        ...
                                                                        {!! Form::token() !!}
                                                                        <input type="hidden" name="id" value="{{$i->idinformetr}}">
                                                                        <button type="button" onclick="{{"ConfirmarArchivar('".$e->coddocumento."-".$e->anio."')"}}" class="btn btn-default"><span class="fa fa-archive" title="Archivar"></span></button>
                                                                        {!! Form::close() !!}
                                                                    @endif
                                                                    ...
                                                                    @if($i->estado!='P')
                                                                        ...
                                                                        {!! Form::token() !!}
                                                                        <input type="hidden" name="id" value="{{$e->idinformetr}}">
                                                                        <button type="submit" class="btn btn-default" title="Proveido"><span class="fa fa-edit"></span></button>
                                                                        {!! Form::close() !!}
                                                                    @endif
                                                                </td>
                                                            </tr>
