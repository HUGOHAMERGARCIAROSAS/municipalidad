                                                    ...
                                                    <table class="table table-hover text-center table-sm">
                                                        ...
                                                        @foreach($movimientos as $m)
                                                            <tr style="font-size: 12px; padding-top: 3px; padding-bottom: 3px; height: 11px;">
                                                                ...
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 11px;">@if(isset($m->fecha_insert)){{$m->fecha_insert." a las ".$m->hora_insert}}@endif</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 11px;">{{$m->usuario_usuario}}</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 11px;">@if(isset($m->fecha_delete)){{$m->fecha_delete." a las ".$m->hora_delete}}@endif</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 11px;">{{$m->usuario_delete}}</td>
