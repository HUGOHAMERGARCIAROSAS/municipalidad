                            ...
                            <div class="card card-gray">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 text-center">
                                            <button type="reset" class="btn btn-warnin btn-smg"><span class="fa fa-brush"></span>
                                                Limpiar
                                            </button>
                                        </div>
                                    </div>
                                                ...
                                                @if(isset($movimientos))
                                                    <table class="table table-hover text-center table-sm">
                                                        ...
                                                        @foreach($movimientos as $m)
                                                            ...
                                                            <tr style="font-size: 12px; padding-top: 3px; padding-bottom: 3px; height: 12px;">
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 12px;">{{$m->expediente}}</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 12px;">{{$m->are_descripcion}}</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 12px;">{{$m->estadodoc}}</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height:  12px;">{{$m->copia}}</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 12px;">{{$m->observacion}}</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 12px;">{{$m->fecha." ".$m->hora}}</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 12px;">{{$m->nro_dias}}</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 12px;">{{$m->folios}}</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 12px;">@if($m->estado==1)
                                                                        <span class="fa fa-check"></span>  @else <span
                                                                                class="fa fa-close"></span> @endif</td>
                                                                <td style=" padding-top: 3px; padding-bottom: 3px; height: 12px;">
                                                                    ...
                                                                    @if($m->estado==1)
                                                                        ...
                                                                        {!! Form::close() !!}
                                                                    @endif
                                                                    @include('tramitedocumentario.mantenedores.adjuntarmov')
                                                                    <button type="button" class="btn btn-default btn-xs"
                                                                            data-toggle="modal"
                                                                            data-target="{{"#modal-adjuntarmov-".$i}}"
                                                                            title="Adjuntar"><span
