                                    ...
                                    <div class="row">
                                        <div class="form-group-lg col-lg-8 col-md-8 col-sm8">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="descripcion"
                                                value="{{$tipotramite[0]->tptra_descripcion}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group-lg col-lg-8 col-md-8 col-sm-8">
                                            <label>Área</label>
                                            <select class="form-control form-control-sm select2bs4 select2-blue" name="area">
                                                @foreach($areas as $a)
                                                    @if($a->valor==$tipotramite[0]->tptra_area)
                                                        <option value="{{$a->valor}}" selected>{{$a->texto}}</option>
                                                    @else
                                        ...
                                        <div class="form-group-lg form-check col-lg-6 col-md-6 col-sm-6" style="padding-left: 2.5%; padding-top:1%">
                                            <input type="checkbox" class="form-check-input"
                                                @if($tipotramite[0]->tptra_online==1) checked @endif>
